...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users ('donor_name', 'email', 'password','phone_number', 'donation_amount', 'donation_date', 'message') 
            VALUES ('$donor_name', '$email', '$password','$phone_number', $donation_amount, '$donation_date', '$message')";
